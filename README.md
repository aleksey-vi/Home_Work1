...
Переходим на https://www.packer.io/downloads.html выбираем соответствующую версию. В данном случае Linux 64-bit и версия 1.4.4. скачал файл на пк

cat <путь к скаченному файлу/https://releases.hashicorp.com/packer/1.4.4/packer_1.4.4_linux_amd64.zip | \
...
В секции builders задаем исходный образ, для создания своего в виде ссылки и контрольной суммы. Параметры подключения к создаваемой виртуальной машине.
    ...
    "iso_url": "http://mirror.yandex.ru/centos/7.7.1908/isos/x86_64/CentOS-7-x86_64-Minimal-1908.iso", данную ссылку я заменил на "http://mirror.docker.ru/centos/7.7.1908/isos/x86_64/"
    "iso_checksum": "9a2c47d97b9975452f7d582264e9fc16d108ed8252ac6816239a3b58cef5c53d", указанную чек сумму тоже поменял на ту которая указана тут "http://mirror.docker.ru/centos/7.7.1908/isos/x86_64/sha256sum.txt"
